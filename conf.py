...
BLOG_AUTHOR = "Equipo Mangoosta"  # (translatable)
BLOG_TITLE = "Mangoosta Software SRL"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.mangoosta.com.ve/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://www.mangoosta.com.ve/"
BLOG_EMAIL = "equipo@mangoosta.com.ve"
BLOG_DESCRIPTION = "Cooperativa de innovación y desarrollo de soluciones de software, datos abiertos y gobierno abierto."  # (translatable)

...
_magic_number = 10
_modified_time = 1451142127.784601
_enable_loop = True
...
def render_late_load_js(context):
    ...
    try:
        ...
        if use_bundles:
            if use_cdn:
                __M_writer(u'            <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>\n            <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>\n            <script src="/assets/js/all.js"></script>\n')
            else:
